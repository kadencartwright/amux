/* @ts-self-types="./amuxterm_web.d.ts" */

export class WasmCanvasRenderer {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmCanvasRendererFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmcanvasrenderer_free(ptr, 0);
    }
    /**
    ...
    handle_viewport_change(width_px, height_px, device_pixel_ratio, orientation) {
        ...
        wasm.wasmcanvasrenderer_handle_viewport_change(this.__wbg_ptr, width_px, height_px, device_pixel_ratio, ptr0, len0);
    }
    /**
     * @param {HTMLCanvasElement} canvas
     */
    constructor(canvas) {
        const ret = wasm.wasmcanvasrenderer_new(canvas);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        WasmCanvasRendererFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} surface_json
     * @returns {any}
     */
    render_surface_json(surface_json) {
        const ptr0 = passStringToWasm0(surface_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmcanvasrenderer_render_surface_json(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
if (Symbol.dispose) WasmCanvasRenderer.prototype[Symbol.dispose] = WasmCanvasRenderer.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./amuxterm_web_bg.js": import0,
    };
}

const WasmCanvasRendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmcanvasrenderer_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('amuxterm_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
